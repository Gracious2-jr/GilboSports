...
const PRODUCTS = [
  { id: 1, categoryId: 1, name: "Men Jersey", description: "Sports jersey in various club and plain designs.", gender: "men", price: 15000, priceMax: 20000, image: "men-jersey.jpg", active: true, stock: 30 },
  { id: 2, categoryId: 3, name: "Kids Jersey", description: "Durable, colorful jersey for kids.", gender: "kids", price: 15000, priceMax: 18000, image: "kids-jersey.jpg", active: true, stock: 25 },
  { id: 3, categoryId: 1, name: "Men Casual T-Shirt", description: "Everyday casual t-shirt for men.", gender: "men", price: 15000, priceMax: 20000, image: "men-tshirt.jpg", active: true, stock: 30 },
  { id: 4, categoryId: 1, name: "Men Inner Wear", description: "Everyday men's inner wear, various sizes.", gender: "men", price: 5000, priceMax: 8000, image: "men-innerwear.jpg", active: true, stock: 40 },
  { id: 5, categoryId: 4, name: "Belts", description: "Durable belts for everyday and formal wear.", gender: "unisex", price: 5000, image: "belts.jpg", active: true, stock: 50 },
    { id: 15, categoryId: 4, name: "Jeans", description: "Durable jeans for everyday and formal wear.", gender: "unisex",price: 25000, pricemax: 35000, image: "jeans.jpg", active: true, stock: 50 },
{ id: 6, categoryId: 4, name: "Unisex Shorts", description: "Comfortable everyday shorts for men and women.", gender: "unisex", price: 20000, priceMax: 30000, image: "unisex-shorts.jpg", active: true, stock: 35 },
  { id: 7, categoryId: 4, name: "Socks", description: "Everyday socks, various colors.", gender: "unisex", price: 2000, image: "socks.jpg", active: true, stock: 100 },
  { id: 8, categoryId: 2, name: "Women Inner Wear", description: "Everyday women's inner wear, various sizes.", gender: "women", price: 4000, image: "women-innerwear.jpg", active: true, stock: 40 },
  { id: 9, categoryId: 5, name: "Bedsheets", description: "Soft, durable bedsheets for home use.", gender: "unisex", price: 12000, image: "bedsheets.jpg", active: true, stock: 20 },
  { id: 10, categoryId: 5, name: "Curtains", description: "Quality curtains in various sizes and designs.", gender: "unisex", price: 10000, priceMax: 15000, image: "curtains.jpg", active: true, stock: 15 },
  { id: 11, categoryId: 5, name: "Bedcovers", description: "Warm and stylish bedcovers.", gender: "unisex", price: 20000, image: "bedcovers.jpg", active: true, stock: 15 },
  { id: 12, categoryId: 5, name: "Blankets", description: "Warm blankets in various sizes and thicknesses.", gender: "unisex", price: 25000, priceMax: 50000, image: "blankets.jpg", active: true, stock: 12 },
  { id: 13, categoryId: 6, name: "School & Office Bags", description: "Durable bags for school and office use, various sizes.", gender: "unisex", price: 20000, priceMax: 50000, image: "bags.jpg", active: true, stock: 18 },
  { id: 14, categoryId: 7, name: "Baby Shower Sets", description: "Baby shower gift sets, ready for gifting.", gender: "unisex", price: 30000, image: "baby-shower.jpg", active: true, stock: 10 }
];
